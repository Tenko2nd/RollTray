...
const unsigned long TEMPS_MAX_CALIBRAGE = 9000;
...
bool checkTimerCard1(){
  return ((last_key = 1) && ((millis() - tempsDepart) >= t01));
}

bool checkTimerCard2(){
  return ((last_key == 2) && ((millis() - tempsDepart) >= (t12 + t01)));

}

bool checkTimerCard3(){
  return ((last_key == 3) && ((millis() - tempsDepart) >= (t23 + t12 + t01)));

}

bool checkTimerCard4(){
  return ((last_key == -2) && ((millis() - tempsDepart) >= (t34 + t23 + t12 + t01)));
